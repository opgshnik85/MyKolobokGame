...
class GameScene: SKScene {
    ...
    var soundCoin = SKAction.playSoundFileNamed("Sound_coin.mp3")
    var soundJump = SKAction.playSoundFileNamed("Sound_jump.wav")
    var soundCollision = SKAction.playSoundFileNamed("Sound_collision.wav")
    ...
    override func didMove(to view: SKView) {
        ...
        SKTAudio.sharedInstance().playBGMusic("Sound_backgroundMusic.mp3")
    }
...
extension GameScene {
    ...
    func createPlayer() {
        player = SKSpriteNode(imageNamed: "kolobok")
        player.name = "Player"
